...
class DataBaseCustomer {
    ...
    private         $_database      = ConfigDB::DB_CUSTOMER;
    /*
    Get an instance of the DataBaseCustomer
    @return Instance
    */
    ...
    public static function execute($sql) {
        // Change this line to reflect whatever DataBaseCustomer system you are using:
    ...
    public static function executeFile($sql) {
        // Change this line to reflect whatever DataBaseCustomer system you are using:

        if ( $stmt = self::getInstance() -> getConnection() -> prepare($sql) )
            if ( $stmt -> execute() )
                return true;
    }
    ...
    function checkErrors($sql) {
        ...
        if($errno) {
            ...
            $message = "The following SQL command ".$sql." caused DataBaseCustomer error: ".$err.".";
