            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="website_url" name="website_url" placeholder="website_url" value="<?php echo $website_url ?>" >
                    </div>

                    <div class="form-group">
                        <label for="main_keyphrase">[Main_Keyphrase]</label>
                        <input type="text" class="form-control" id="main_keyphrase" name="main_keyphrase" placeholder="main_keyphrase" value="<?php echo $main_keyphrase ?>" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="business_address" name="business_address" placeholder="business_address" value="<?php echo $business_address; ?>">
                    </div>

                    <div class="form-group">
                        <label for="abn">[ABN]</label>
                        <input type="text" class="form-control" id="abn" name="abn" placeholder="abn" value="<?php echo $abn; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="2" id="call_to_action" name="call_to_action" placeholder="call_to_action"><?php echo $call_to_action ?></textarea>
                    </div>
                </div>
            </div>
        </div>
