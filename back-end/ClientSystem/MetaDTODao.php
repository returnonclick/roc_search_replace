...
/**
 * MetaDTO Data Access Object (DAO).
 * This class contains all database handling that is needed to
 * permanently store and retrieve MetaDTO object instances.
 */
...
class MetaDTODao {
     ...
     */
    function getObject($conn, $meta_id) {

        $valueObject = $this->createValueObject();
        $valueObject->setMeta_id($meta_id);
    ...
    function load($conn, $valueObject) {
        ...
        if (!$valueObject->getMeta_id()) {
            print "Can not select without Primary-Key!";
            return false;
        }

        $sql = "SELECT * FROM roc_meta WHERE (meta_id = ".$valueObject->getMeta_id().") ";
    ...
    function save($conn, $valueObject) {
        ...
        $sql = "UPDATE roc_meta SET roc_id = ".$valueObject->getRoc_id().", ";
        $sql = $sql."meta_key = '".$valueObject->getMeta_key()."', ";
        $sql = $sql."meta_value = '".$valueObject->getMeta_value()."'";
        $sql = $sql." WHERE (meta_id = ".$valueObject->getMeta_id().") ";
        $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
        ...
        $sql = "DELETE FROM roc_meta WHERE (meta_id = ".$valueObject->getMeta_id().") ";
        $result = $this->databaseUpdate($conn, $sql);
