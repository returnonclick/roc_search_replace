					...
					<div class="col-xs-12">
						<article <?php post_class( 'post-inner' ); ?>>
							...
							<div class="meta-data">
								...
								<span class="meta-data__comments"><a href="<?php comments_link(); ?>"><?php the_nice_comments_number(); ?></a></span>
							</div>
							<h2 class="hentry__title"><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a></h1>
